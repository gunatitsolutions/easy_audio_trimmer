...
class _TrimViewerState extends State<TrimViewer> with TickerProviderStateMixin {
  final ValueNotifier<bool?> _isScrollableAllowed = ValueNotifier<bool?>(null);
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool?>(
      ...
      builder: (context, isScrollableAllowed, child) {
        return isScrollableAllowed == null ? fixedTrimViewer : const SizedBox();
      },
    );
  }
